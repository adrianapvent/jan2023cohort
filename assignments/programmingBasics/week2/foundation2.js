...
function biggie(arr) {
    for(let i = 0; i < arr.length; i++) {
        if(arr[i] > 0) { // if array index is greater than 0
...
function lowHigh (arr) {
    ...
    let max = 0
    for(let i = 0; i < arr.length; i++) { 
        if(arr[i] < min) { // function for replacing lowest value 
    ...
    for(let i = 0; i < arr.length; i++) {
        if(arr[i] > max) { // function for replacing highest value
            max = arr[i] // set new high value
        }
    }
    // console.log('max')
    // let result = {min: min, max:max}
    // console.log(`${min}, ${max}`) // populate result for min and max
    // return result
}
